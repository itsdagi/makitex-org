...
export default function SettingsManager() {
  ...
  const defaultSettings = [
    ...
    { key: "hero_description", value: "Makitex Trading PLC delivers integrated solutions across advertising, office supplies, and engineering — a complete end-to-end partner for branding, renovation, and new construction.", category: "hero" },
    { key: "hero_phone", value: "+251 71 485 7133", category: "hero" },
    { key: "about_title", value: "A Legacy Built on Concrete Promises.", category: "about" },
    { key: "about_content", value: "Our journey began with a global exploration — our founders traveled the world to immerse themselves in diverse work cultures and innovative design philosophies. They drew inspiration from collaborative environments and efficient workspaces, recognizing a need for a more integrated approach back home in Ethiopia. From this international perspective, Makitex Trading was founded with a singular bold vision: to become the ultimate one-stop solution for all office design needs. We provide a seamless experience from initial branding and interior design concepts to final construction, ensuring every workspace is not just functional but a reflection of modern, globally-inspired work culture.", category: "about" },
    { key: "contact_email", value: "makitextrading@gmail.com", category: "contact" },
    { key: "contact_address", value: "Adwa Bridge Road, Nati Irb Bldg, 3rd Floor, Addis Ababa, Ethiopia", category: "contact" },
    { key: "social_linkedin", value: "https://linkedin.com/company/makitex", category: "social" },
    { key: "social_facebook", value: "https://facebook.com/makitex", category: "social" },
